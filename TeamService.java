...
public class TeamService {
	...
	public Team addTeam(String teamName) {
		...
		for (Team teamExist : teams) {
			if(teamExist.getName().equals(teamName)) {
				return teamExist;
			}
		}
	...
	public Team getTeam(String teamName) {
		...
		for (Team teamExistAssign : teams) {
			if (teamExistAssign.getName().equals(teamName)) {
				team = teamExistAssign;
			}
		}
